    ...
    <aside className="w-64 flex-shrink-0 flex flex-col h-full border-r" style={{ background: 'var(--panel)', borderColor: 'var(--border)' }}>
      ...
      <div className="px-4 py-3 border-b" style={{ borderColor: 'var(--border)' }}>
        ...
        {['Settings', 'Members', 'Billing', 'API keys'].map(item => (
          <div key={item} className="py-1.5 px-2 text-sm rounded cursor-default" style={{ color: 'var(--muted)' }}>
            {item}
          </div>
        ))}
      </div>
      ...
      <div className="px-4 py-3 flex-1">
        ...
        <Link
          ...
          style={{
            background: pathname === '/rehearse' ? 'var(--border)' : 'transparent',
            color: pathname === '/rehearse' ? 'var(--text)' : 'var(--muted)',
          }}
        >
        ...
        <Link
          ...
          style={{
            background: pathname === '/drone' ? 'var(--border)' : 'transparent',
            color: pathname === '/drone' ? 'var(--text)' : 'var(--muted)',
          }}
        >
      ...
      <div className="px-4 py-3 border-t" style={{ borderColor: 'var(--border)' }}>
        {[
          ...
          <a
            ...
            className="flex items-center gap-1 py-1.5 px-2 text-sm rounded-md transition-colors hover:opacity-80"
