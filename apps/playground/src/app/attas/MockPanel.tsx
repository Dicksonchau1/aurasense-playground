...
export default function AttasMockPanel() {
  ...
  return (
    <div className="bg-gray-900 p-4 rounded mt-4">
      <h3 className="font-bold mb-2">Mock ATTAS Data</h3>
      ...
      {data ? (
        <pre className="text-xs bg-gray-800 p-2 rounded overflow-x-auto">{JSON.stringify(data, null, 2)}</pre>
      ) : (
        <div>Loading...</div>
      )}
    </div>
